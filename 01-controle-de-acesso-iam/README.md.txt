...
Este projeto tem como objetivo simular um ambiente corporativo de controle de acesso utilizando recursos nativos do sistema operacional Linux. Foram aplicados conceitos fundamentais de Segurança da Informação, como autenticação, autorização e o princípio do menor privilégio.
